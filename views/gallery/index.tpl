                    ...
                    <a href="#">
                      <div class="square-1">
                        <div class="img-container">
                          <img src="<?php echo UURL;?>img/gallery/01.jpg" alt="">
                ...
                <li>
                  <article class="span3 project" data-tags="webdesign">     
                    <a href="#">
                      <div class="square-1">
                        <div class="img-container">
                          <img src="<?php echo UURL;?>img/gallery/02.jpg" alt="">
                          <div class="img-bg-icon"></div>
                        </div>
                        <h3>Photo Ucorpora</h3>
                          More description about photo 
                ...
                <li>
                  <article class="span3 project" data-tags="photography,identity">     
                    <a href="#">
                      <div class="square-1">
                        <div class="img-container">
                          <img src="<?php echo UURL;?>img/gallery/03.jpg" alt="">
                          <div class="img-bg-icon"></div>
                        </div>
                        <h3>Photo Ucorpora</h3>
                          More description about photo 
                ...
                <li>
                  <article class="span3 project" data-tags="identity,architecture">     
                    <a href="#">
                      <div class="square-1">
                        <div class="img-container">
                          <img src="<?php echo UURL;?>img/gallery/04.jpg" alt="">
                          <div class="img-bg-icon"></div>
                        </div>
                        <h3>Photo Ucorpora</h3>
                          More description about photo 
                ...
                <li>
                  <article class="span3 project" data-tags="architecture,technology">     
                    <a href="#">
                      <div class="square-1">
                        <div class="img-container">
                          <img src="<?php echo UURL;?>img/gallery/05.jpg" alt="">
                          <div class="img-bg-icon"></div>
                        </div>
                        <h3>Photo Ucorpora</h3>
                          More description about photo 
                ...
                <li>
                  <article class="span3 project" data-tags="technology,webdesign">     
                    <a href="#">
                      <div class="square-1">
                        <div class="img-container">
                          <img src="<?php echo UURL;?>img/gallery/06.jpg" alt="">
                          <div class="img-bg-icon"></div>
                        </div>
                        <h3>Photo Ucorpora</h3>
                          More description about photo 
                ...
                <li>
                  <article class="span3 project" data-tags="architecture">     
                    <a href="#">
                      <div class="square-1">
                        <div class="img-container">
                          <img src="<?php echo UURL;?>img/gallery/07.jpg" alt="">
                          <div class="img-bg-icon"></div>
                        </div>
                        <h3>Photo Ucorpora</h3>
                          More description about photo 
                ...
                <li>
                  <article class="span3 project" data-tags="identity,technology">     
                    <a href="#">
                      <div class="square-1">
                        <div class="img-container">
                          <img src="<?php echo UURL;?>img/gallery/08.jpg" alt="">
                          <div class="img-bg-icon"></div>
                        </div>
                        <h3>Photo Ucorpora</h3>
                          More description about photo 
                ...
                <li>
                  <article class="span3 project" data-tags="webdesign, architecture">     
                    <a href="#">
                      <div class="square-1">
                        <div class="img-container">
                          <img src="<?php echo UURL;?>img/gallery/09.jpg" alt="">
                          <div class="img-bg-icon"></div>
                        </div>
                        <h3>Photo Ucorpora</h3>
                          More description about photo 
                ...
                <li>
                  <article class="span3 project" data-tags="technology,webdesign">     
                    <a href="#">
                      <div class="square-1">
                        <div class="img-container">
                          <img src="<?php echo UURL;?>img/gallery/10.jpg" alt="">
                          <div class="img-bg-icon"></div>
                        </div>
                        <h3>Photo Ucorpora</h3>
                          More description about photo 
                ...
                <li>
                  <article class="span3 project" data-tags="architecture,photography">     
                    <a href="#">
                      <div class="square-1">
                        <div class="img-container">
                          <img src="<?php echo UURL;?>img/gallery/11.jpg" alt="">
                          <div class="img-bg-icon"></div>
                        </div>
                        <h3>Photo Ucorpora</h3>
                          More description about photo 
                ...
                <li>
                  <article class="span3 project" data-tags="technology,identity,architecture">     
                    <a href="#">
                      <div class="square-1">
                        <div class="img-container">
                          <img src="<?php echo UURL;?>img/gallery/12.jpg" alt="">
                          <div class="img-bg-icon"></div>
                        </div>
                        <h3>Photo Ucorpora</h3>
                          More description about photo 
