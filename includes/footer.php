  ...
  <!-- JavaScripts -->
  <script type="text/javascript" src="<?php echo UURL;?>js/jquery-1.8.3.min.js"></script> 
  <script type="text/javascript" src="<?php echo UURL;?>js/bootstrap.min.js"></script>  
  <script type="text/javascript" src="<?php echo UURL;?>js/functions.js"></script>
  <script type="text/javascript" defer src="<?php echo UURL;?>js/jquery.flexslider.js"></script>
